import { ArrowLeft, Headphones, PlayCircle, Volume2, Volume1, Timer, ChevronRight } from 'lucide-react'
...
export const ListeningPractice = () => {
  ...
  const sections = [
    {
      title: "Section 1",
      description: "Social Needs - Daily life conversation between two people",
      duration: "10-12 minutes",
      icon: Volume1,
    },
    {
      title: "Section 2",
      description: "Social Needs - Monologue about everyday social context",
      duration: "10-12 minutes",
      icon: Volume1,
    },
    {
      title: "Section 3",
      description: "Educational/Training - Conversation between up to four people",
      duration: "12-15 minutes",
      icon: Volume2,
    },
    {
      title: "Section 4",
      description: "Educational/Academic - Academic monologue",
      duration: "12-15 minutes",
      icon: Volume2,
    },
  ];
  ...
  const handleStartTest = (sectionIndex: number) => {
    navigate(`/listening/practice/test/${sectionIndex + 1}`);
  };
      ...
      <main className="container mx-auto px-6 sm:px-8 py-16">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-center text-gray-600 mb-12">
            Choose a section to practice your listening skills.
          </p>
